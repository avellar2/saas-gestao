              ...
              <View style={styles.infoCol}>
                ...
                {serviceOrder.priority && serviceOrder.priority !== "NORMAL" && (
                  <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoValueNormal}>{getPriorityLabel(serviceOrder.priority)}</Text>
                  </View>
                )}
                <View style={styles.infoRow}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.warningBox}>
              {serviceOrder.warrantyStartDate && (
                ...
                >
                  <Text style={styles.paymentLabel}>Início:</Text>
                  <Text style={styles.paymentValue}>
                    {formatDatePDF(serviceOrder.warrantyStartDate)}
                  </Text>
                </View>
              )}
              {serviceOrder.warrantyEndDate && (
                ...
                >
                  ...
                  <Text style={styles.paymentValue}>
                    {formatDatePDF(serviceOrder.warrantyEndDate)}
                  </Text>
                </View>
              )}
